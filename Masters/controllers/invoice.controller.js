...
module.exports = {
  ...
  //       console.log("📋 Sale Order Lines:", subscription.order_line);

  //       console.log("💳 Step 10: Creating invoice and linking to sale order lines...");
  //       let invoice_id = null;
  //       let payment_id = null;
  //       let secretKey = null;
  //       let emailSent = false;
  ...
  //         if (invoiceLines.length > 0 && saleOrderLines.length > 0) {
  //           const invoiceLineId = invoiceLines[0].id;
  //           const saleOrderLineId = saleOrderLines[0];
  ...
  //               [invoiceLineId],
  //               { sale_line_ids: [[4, saleOrderLineId]] }
  //             ]);
  ...
  //               ["invoice_ids"]
  //             ]);
  //             console.log("   📋 Subscription invoice_ids after linking:", verifySubscription[0].invoice_ids);

  //             if (verifySubscription[0].invoice_ids && verifySubscription[0].invoice_ids.includes(invoice_id)) {
  //               console.log("   ✅✅✅ SUCCESS! Invoice automatically appeared in subscription's invoice_ids!");
  //             } else {
  //               console.log("   ⚠️ Invoice not yet in invoice_ids, may need to refresh/recompute");
  //             }
  //           } catch (linkError) {
  //             console.error("   ❌ Error linking invoice line to sale order line:", linkError.message);
  //           }
  //         } else {
  ...
  //         console.log("🔍 Step 10.4: Finding payment journal...");
  //         const journals = await odooService.execute(
  //           "account.journal",
  //           "search_read",
  //           [
  ...
  //         console.log("💰 Step 10.5: Creating payment...");
  //         const paymentAmount =
  //           invoice.amount_residual || invoice.amount_total || price_unit;
  ...
  //         console.log("📧 Step 10.6: Sending confirmation email...");
  //         const partnerEmail = await odooService.execute("res.partner", "read", [
  //           [partner_id],
  //           ["email", "name"],
  //         ]);
  ...
  //         console.log("📋 Step 10.7: Creating client plan details...");
  //         const clientPlanData = {
  //           partner_id: partner_id,
  //           product_id: product_id,
  //           secret_key: secretKey,
  ...
  //         "sale.order",
  //         "read",
  //         [[sale_order_id], ["invoice_ids", "name"]]
  //       );
  //       console.log("📋 Final subscription invoice_ids:", finalSubscription[0].invoice_ids);
